...
args__5733__auto__.push((arguments[i__5727__auto___16125]));
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq16123){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16123));
});
/**
...
var vec__16128 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16128,(0),null);
var words = cljs.core.nthnext(vec__16128,(1));
...
var G__16130 = clojure.set.rename_keys(m,kmap);
var G__16130__$1 = ((cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__16130,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys):G__16130);
return G__16130__$1;
} else {
return m;
}
...
args__5733__auto__.push((arguments[i__5727__auto___16134]));
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__16131_SHARP_){
if(cljs.core.list_QMARK_(p1__16131_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16131_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__16131_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq16132){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16132));
});
/**
...
var vec__16139 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16139,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16139,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__16139,tag_name,names){
return (function (p1__16136_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__16136_SHARP_));
});})(matches,vec__16139,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__16139,tag_name,names){
return (function (p1__16137_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__16137_SHARP_));
});})(matches,vec__16139,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__16140){
var vec__16143 = p__16140;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16143,(0),null);
var content = cljs.core.nthnext(vec__16143,(1));
...
var vec__16144 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16144,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16144,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16144,(2),null);
